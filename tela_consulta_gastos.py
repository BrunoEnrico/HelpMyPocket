...
txt_pesquisa = TextInput(
    multiline=False,
    size_hint=(0.6, .05),
    hint_text="Pesquise aqui... Ex: Netflix",
    pos_hint={'x': .15, 'y': .70}
)
...
floatlayout.add_widget(btn_voltar)
floatlayout.add_widget(btn_pesquisar)
floatlayout.add_widget(txt_pesquisa)
